<aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                @php
                    $user = Auth::user();
                    $dashboardRoute = $user && $user->role == 'kasir' ? 'dashboard-kasir' : 'dashboard';
                @endphp
                <a class="nav-link text-white {{ Route::currentRouteName() == $dashboardRoute ? ' active bg-gradient-primary' : '' }} "
    ...
    <div class="sidenav-footer position-absolute w-1p00 bottom-0 ">
        <div class="mx-3">
